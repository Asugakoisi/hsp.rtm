...
namespace hsp.rtm
{
    public static class Base
    {
        ...
        public static void Limit(List<string> sentence, int j, int k)
        {
            ...
            {
                if (Analyzer.VariableList.Contains(sentence[0]))
                {
                    sentence[0] = "if ((int)Math.Max(" + p[0] + "," + p[2] + ") == " + p[0] + ")\n" +
                                  "{\n" + sentence[0] + " = (int)" + p[2] + ";\n}\nelse if ((int)Math.Min(" + p[0] + "," +
                                  p[1] + ") == " + p[0] + ")\n" +
                                  "{\n" + sentence[0] + " = (int)" + p[1] + ";\n}\nelse\n{\n" + sentence[0] + " = (int)" +
                                  p[0] + ";\n}";
                }
        ...
        public static void Gettime(List<string> sentence, int j)
        {
            ...
            switch (sentence[j + 2])
            {
                ...
                case "1":
                    ...
                    break;
                case "2":
                    var dayOfTheWeek = Analyzer.__LocalName("dayOfTheWeek");
                    Analyzer.SubFunction += "static int " + dayOfTheWeek + "(string str)\n{\n"
                                           + "switch(str)\n{\ncase \"日\":\nreturn 0;" + "\ncase \"月\":\nreturn 1;"
                                           + "\ncase \"火\":\nreturn 2;" + "\ncase \"水\":\nreturn 3;"
                                           + "\ncase \"木\":\nreturn 4;" + "\ncase \"金\":\nreturn 5;"
                                           + "\ncase \"土\":\nreturn 6;" + "\ndefault:\nreturn -1;\n}\n}\n";
